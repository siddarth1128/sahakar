...
export default function WaveBackground({ backdropBlurAmount = "sm", className = "" }) {
  ...
  return (
    <div className={`w-full h-full absolute inset-0 overflow-hidden ${className}`} aria-hidden>
      <canvas
        ref={canvasRef}
